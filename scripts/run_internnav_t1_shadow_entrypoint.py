#!/usr/bin/env python3
"""Run official Isaac evaluation with legacy-primary / ROS2-shadow actions."""
...
from internvla_shadow_agent_client import make_shadow_client
...
def main() -> None:
    ...
    internnav.utils.AgentClient = make_shadow_client(LegacyAgentClient)
